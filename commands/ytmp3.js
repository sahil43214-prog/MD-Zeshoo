// .ytmp3 — Download YouTube video as MP3 audio (link ya search query dono chalega)
...
async function ytmp3Command(sock, from, msg, q) {
    if (!q) return await sock.sendMessage(from, { text: '❌ Usage: `.ytmp3 <YouTube link ya song ka naam>`' }, { quoted: msg });
    ...
    await sock.sendMessage(from, { text: `🎵 *YTMP3 Download*\n\n📌 ${video.title}\n⏱ Duration: ${video.timestamp || 'N/A'}` }, { quoted: msg });
    ...
    for (const apiMethod of apiMethods) {
        try {
            ...
            console.log(`[ytmp3] ${apiMethod.name} failed:`, err.message);
        }
    }
